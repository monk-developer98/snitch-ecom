                    ...
                    <form onSubmit={handleSubmit} className="pt-14 pb-24">
                        ...
                        <div className="mt-16 lg:mt-20">
                            <button
                                ...
                                className="w-full py-5 text-[11px] cursor-pointer uppercase tracking-[0.3em] font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                                style={{
