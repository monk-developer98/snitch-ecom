            ...
            <div className="w-full lg:w-[65%]">
              ...
              <div className="flex flex-col gap-6">
                {cart?.items?.map((item) => {
                  ...
                  const attributes = variantDetail[0]?.attributes ?? {};
                  const stock = variantDetail[0]?.stock;
                  const variantPrice = variantDetail[0]?.price;
                  return (
                    <div
                      key={_id}
                    ...
                    >
                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        <div>
                          ...
                          {displayPrice?.amount !== variantPrice[0]?.amount && (
                            <>
                              {displayPrice?.amount > variantPrice[0]?.amount ? (
                                <p className="text-[10px] uppercase tracking-[0.15em] mb-4 text-green-800 font-bold">
                                  ...
                                  {formatCurrency(
                                    variantPrice[0]?.amount,
                                    variantPrice[0]?.currency,
                                  )}{" "}
                                  save{" "}
                                  {Math.abs(
